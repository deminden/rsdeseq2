...
readme <- c(
  ...
  "",
  "This generated bundle uses saved contrasts from publication datasets.",
  "It provides inputs for validating the standalone pure-Rust implementation of R-style L-BFGS-B behavior used by DESeq2's GLM beta fallback.",
  "",
  "`global_hardest_512.tsv` ranks selected rows across all processed contrasts by optimizer use, rough or non-converged IRLS starts, forced-optimizer beta movement, and iteration count.",
  "",
  ...
  "- `beta_no_optim.tsv`: IRLS starting coefficients.",
