...
pub use crate::contrasts::{
    ContrastSpec, FactorLevelContrast, ResolvedResultsContrast, ResultsContrast,
    ResultsContrastAllZero, contrast_all_zero_factor_levels, contrast_all_zero_numeric,
    factor_level_contrast_from_model_frame, resolve_coefficient_index, resolve_contrast,
    resolve_results_contrast,
};
pub use crate::cooks::{
    CooksOutput, CooksRefitPlan, CooksReplacementMetadata, CooksReplacementMetadataEntry,
    CooksReplacementOptions, CooksReplacementOutput, calculate_cooks_distance,
    max_cooks_after_replacement_refit, prepare_cooks_replacement_refit, record_max_cooks,
    replace_outlier_counts, robust_method_of_moments_dispersion, samples_for_cooks,
};
pub use crate::core::{
    CooksReplacementLrtOutput, CooksReplacementTestOutput, CooksReplacementWaldOutput, CountMatrix,
    CountsSummary, DEFAULT_FAST_VST_NSUB, DeseqBuilder, DeseqFit, FastVstGlmMuMetadata,
    FastVstGlmMuOutput, FrozenRlogGlmMuMetadata, FrozenRlogGlmMuOutput, RlogDesignMode,
    RlogGlmMuMetadata, RlogGlmMuOutput, VstFullDataReason, VstGlmMuMetadata, VstGlmMuOutput,
    VstTrendSource,
};
pub use crate::design::{
    ...
    ResolvedFormulaNumericCovariate, expanded_additive_design,
    expanded_additive_design_with_all_interactions, expanded_additive_design_with_interactions,
    expanded_additive_factor_design, expanded_factor_design, expanded_formula_design,
    expanded_formula_design_from_model_frame, expanded_formula_design_with_offsets,
    expanded_formula_design_with_offsets_from_model_frame,
};
...
pub use crate::dispersion::{
    DispersionLineSearchOutput, DispersionPrior, DispersionPriorVarianceOutput, DispersionTrendFit,
    ...
    parametric_trend_use_for_fit, rough_dispersion_estimates,
};
...
pub use crate::glm::{
    ...
    WaldTestOptions, average_expanded_model_coefficients, average_expanded_model_covariances,
...
pub use crate::independent_filtering::{
    IndependentFilterLowessRow, IndependentFilterMetadataEntry, IndependentFilterNumRejRow,
    IndependentFilteringOptions, IndependentFilteringOutput, apply_independent_filtering,
    default_theta, filtered_p_adjustments, lowess_fitted_values, select_filter_index,
    select_filter_index_with_lowess,
};
pub use crate::io::{
    read_count_matrix_tsv, write_base_mean_tsv, write_base_metadata_tsv,
    write_cooks_candidate_replacement_counts_tsv, write_cooks_distance_matrix_tsv,
    write_cooks_distance_tsv, write_cooks_outlier_cells_tsv, write_cooks_replaced_counts_tsv,
    write_cooks_replacement_metadata_tsv, write_cooks_replacement_row_metadata_tsv,
    write_cooks_row_metadata_tsv, write_cooks_sample_metadata_tsv, write_count_matrix_tsv,
...
pub use crate::results::{
    DESEQ2_RESULT_CORE_COLUMNS, DeseqResultColumn, DeseqResultColumnMetadata,
    ...
    ExpandedFormulaModelFrameBetaPriorWaldResultsInput, RSDESEQ2_RESULT_DIAGNOSTIC_COLUMNS,
...
pub use crate::transform::{
    FastVstSubset, FastVstSubsetMetadata, RLOG_INTERCEPT_PRIOR_VARIANCE, RLOG_PRIOR_UPPER_QUANTILE,
    RlogFitOutput, RlogMetadata, RlogOffsetMode, RlogOutput, estimate_rlog_sample_prior_variance,
